...
describe('Cache', () => {
  ...
  describe('load', () => {
    it('returns empty cache when no cache exists', async () => {
      const cache = await Cache.load(testDir, testDir)
    ...
    it('loads existing cache from disk', async () => {
      ...
      const loaded = await Cache.load(testDir, testDir)
  ...
  describe('diff', () => {
    ...
    it('detects unchanged files', async () => {
      ...
      const cache2 = await Cache.load(testDir, testDir)
    ...
    it('detects deleted files', async () => {
      ...
      const cache3 = await Cache.load(testDir, testDir)
  ...
  describe('write', () => {
    ...
    it('does not write when not dirty', async () => {
      ...
      loaded.write()
      const loaded2 = await Cache.load(testDir, testDir)
